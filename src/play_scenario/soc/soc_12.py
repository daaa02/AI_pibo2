...
def Play_King(user_name):
    ...
    def start():
        ...
        while True:
            text_to_speech("<랜덤공간>이 어떻게 생겼는지 알고 싶어. <랜덤공간>에는 무슨 색깔이 있어?")
            user_said = speech_to_text()
            break
        ...
        while True:
            ...
            text_to_speech(f"{user_name}이는 정말 설명을 잘해주는 구나! 눈이 안보여도 <랜덤공간>이 어떻게 생겼는지 알 것 같아!")   
            break
